...
WILDCARD_VALUES = [ofp.OFPXMT_OFB_IN_PORT,
                   ofp.OFPXMT_OFB_VLAN_VID,
                   ofp.OFPXMT_OFB_ETH_TYPE,
                   ofp.OFPXMT_OFB_IP_PROTO,
                   ofp.OFPXMT_OFB_VLAN_PCP,
                   ofp.OFPXMT_OFB_IP_DSCP]

MODIFY_ACTION_VALUES =  [ofp.OFPXMT_OFB_VLAN_VID,
                         ofp.OFPXMT_OFB_VLAN_PCP,
                         ofp.OFPXMT_OFB_ETH_SRC,
                         ofp.OFPXMT_OFB_ETH_DST,
                         ofp.OFPXMT_OFB_IPV4_SRC,
                         ofp.OFPXMT_OFB_IPV4_DST,
                         ofp.OFPXMT_OFB_IP_DSCP,
                         ofp.OFPXMT_OFB_TCP_SRC,
                         ofp.OFPXMT_OFB_TCP_DST]
...
def vlan_pop_two_tables_tests(parent, test_condition=0, match_exp=True):
    ...
    if (match_exp):
        ...
        vid_match_tbl1 = vid + 1
        pcp_match_tbl1 = pcp + 1
