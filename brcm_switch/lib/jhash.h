...
//typedef  unsigned long long int  unsigned long long int;
...
struct __una_uint16_t { unsigned short int x; } ;
struct __una_uint32_t { unsigned int x; } ;
struct __una_uint64_t { unsigned long long int x; } ;

static inline unsigned int __get_unaligned_cpuint32_t(const void *p)
{
