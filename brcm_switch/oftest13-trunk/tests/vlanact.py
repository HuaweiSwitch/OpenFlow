...
class VlanActNonTagPush0(pktact.BaseMatchCase):
    ...
    def runTest(self):
        vlan_singlepush_act_tests(self, test_condition=0)#Must modify 2->0
...
class VlanActNonTagPushSetPcp(VlanActNonTagPush0):
    ...
    """
    def runTest(self):
        vlan_multipush_act_tests(self, test_condition=4)
...
class VlanActOneTagPushPop(VlanActOneTagPop):
    """
