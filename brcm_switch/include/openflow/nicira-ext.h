...
struct nicira_header {
    ...
    unsigned int vendor;            /* NX_VENDOR_ID. */
    unsigned int subtype;           /* One of NXT_* above. */
};
...
struct nxt_tun_id_cookie {
    struct ofp_header header;
    unsigned int vendor;            /* NX_VENDOR_ID. */
    unsigned int subtype;           /* NXT_TUN_ID_FROM_COOKIE */
    unsigned char set;                /* Nonzero to enable, zero to disable. */
    unsigned char pad[7];
};
...
struct nx_action_resubmit {
    unsigned short int type;                  /* OFPAT_VENDOR. */
    unsigned short int len;                   /* Length is 16. */
    unsigned int vendor;                /* NX_VENDOR_ID. */
    unsigned short int subtype;               /* NXAST_RESUBMIT. */
    unsigned short int in_port;               /* New in_port for checking flow table. */
    unsigned char pad[4];
};
...
struct nx_action_set_tunnel {
    ...
    unsigned short int len;                   /* Length is 16. */
    unsigned int vendor;                /* NX_VENDOR_ID. */
    unsigned short int subtype;               /* NXAST_SET_TUNNEL. */
    unsigned char pad[2];
    unsigned int tun_id;                /* Tunnel ID. */
};
...
struct nx_action_header {
    ...
    unsigned short int len;                   /* Length is 16. */
    unsigned int vendor;                /* NX_VENDOR_ID. */
    unsigned short int subtype;               /* NXAST_*. */
    unsigned char pad[6];
};
