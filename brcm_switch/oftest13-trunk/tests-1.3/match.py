...
class EthSrc(MatchTest):
    ...
    def runTest(self):
        ...
        nonmatching = {
            ...
            "multicast": simple_tcp_packet(eth_src='04:01:02:03:04:05'),
...
class EthSrcBroadcast(MatchTest):
    ...
    def runTest(self):
        match = ofp.match([
            ofp.oxm.eth_src([0xf0, 0xff, 0xff, 0xff, 0xff, 0xff])
        ])

        matching = {
            "ff:ff:ff:ff:ff:ff": simple_tcp_packet(eth_src='f0:ff:ff:ff:ff:ff'),
        }

        nonmatching = {
            "fd:ff:ff:ff:ff:ff": simple_tcp_packet(eth_src='fc:ff:ff:ff:ff:ff'),
            "fe:ff:ff:ff:ff:ff": simple_tcp_packet(eth_src='fe:ff:ff:ff:ff:ff'),
            "ff:fe:ff:ff:ff:ff": simple_tcp_packet(eth_src='fa:fe:ff:ff:ff:ff'),
        }
...
class EthSrcMulticast(MatchTest):
    ...
    def runTest(self):
        match = ofp.match([
            ofp.oxm.eth_src([0x00, 0x00, 0x5e, 0xed, 0x99, 0x02])
        ])

        matching = {
            "correct": simple_tcp_packet(eth_src='00:00:5e:ed:99:02'),
        }

        nonmatching = {
            "incorrect": simple_tcp_packet(eth_src='00:00:5e:ed:99:03'),
            "unicast": simple_tcp_packet(eth_src='00:01:5e:ed:99:02'),
            "broadcast": simple_tcp_packet(eth_src='f0:ff:ff:ff:ff:ff'),
            "local": simple_tcp_packet(eth_src='04:00:5e:ed:99:02'),
        }
...
class EthSrcMasked(MatchTest):
    ...
    def runTest(self):
        ...
        matching = {
            ...
            "ff:01:02:f3:04:05": simple_tcp_packet(eth_src='f0:01:02:f3:04:05'),
        }
